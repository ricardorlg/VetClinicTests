...
public final class OwnerQuestions {
    ...
    public static Question<OwnerPageCompleteInformation> theDisplayedOwnerInformation() {
        return Question.about("the displayed owner personal information")
                .answeredBy(actor -> {
                    ...
                    var petsAndVisits = parsePetsAndVisitsData(actor);
    ...
    private static List<PetsAndVisitsInformation> parsePetsAndVisitsData(Actor actor) {
        ...
        if (rows.isEmpty()) {
            ...
            return rows
                    ...
                    .map(row -> {
                        ...
                        var petBirthDate = parseDate(petBirthDateElement.getText());
                        ...
                        var visits = innerTableRows
                                ...
                                .map(visitRow -> {
                                    var visitDate = parseDate(visitRow.get("Visit Date"));
